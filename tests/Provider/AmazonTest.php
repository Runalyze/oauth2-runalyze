...
namespace Runalyze\OAuth2\Client\Test\Provider;

use Runalyze\OAuth2\Client\Provider\Runalyze;
use PHPUnit\Framework\TestCase;

final class RunalyzeTest extends TestCase
{
    const CLIENT_ID = '0000000001';
    const CLIENT_SECRET = 'XXXXXXXXX';
    const REDIRECT_URI = 'https://example.com/connect/check';

    protected Runalyze $provider;

    public function setUp(): void
    {
        $this->provider = new Runalyze([
    ...
    public function testBaseAuthorizationUrl(): void
    {
        ...
        $this->assertEquals('runalyze.com', $resource['host']);
